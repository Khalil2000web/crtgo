  ...
  <ul className="space-y-1 text-gray-700">
    ...
    <li className="flex justify-between">
      ...
      <footer className="mt-12 border-t border-[#1111111c] text-center flex flex-col gap-4 items-center justify-center py-8">
        ...
        <p>&copy; 2025 Khalil Cafe — جميع الحقوق محفوظة</p>
        <p>
          <Link href="/terms">شروط الاستخدام</Link>
        </p>
        <p>
          CREATED BY <Link href="/">CRTGO, WEB SERVICES</Link>
        </p>
      </footer>
        ...
        >
          ...
          >
            <Dialog.Panel className="bg-[#fefefe] rounded w-[90%] max-w-lg p-6 text-center relative">
              <div className="relative w-full max-h-[280px] mb-4 h-[280px]">
                <Image
                  src={overlayData.img}
              ...
              <Dialog.Title className="text-lg font-semibold mb-1">{overlayData.name}</Dialog.Title>
